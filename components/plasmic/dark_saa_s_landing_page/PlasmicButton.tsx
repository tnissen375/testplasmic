...
import sty from "./PlasmicButton.module.css"; // plasmic-import: SucKEMjaz479Sp/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__mmIbF)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__sd4Cp)}
                role={"img"}
              />
            ),
