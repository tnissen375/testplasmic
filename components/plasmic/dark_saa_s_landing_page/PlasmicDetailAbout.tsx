...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: VaSCgwWQs1GTiT/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__glFu7)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__ebHq)}>
            <h5
