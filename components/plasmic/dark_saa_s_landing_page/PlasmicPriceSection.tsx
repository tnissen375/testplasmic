...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: 2IKUaPg-aMKIJD/css
    ...
    >
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__bdkG4)}
        >
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__e7SNn)}>
              <PriceCard
                borders={["flatLeft"]}
                className={classNames("__wab_instance", sty.priceCard__ilaNp)}
              />
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox___257ZY)}>
              <div className={classNames(projectcss.all, sty.freeBox__svh69)}>
                <div
              ...
              {(
                ...
                <PriceCard
                  borders={["flatCenter"]}
                  className={classNames("__wab_instance", sty.priceCard__gwXb)}
                />
              ) : null}
            </div>
          ) : null}
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__qtkQn)}>
              <PriceCard
                borders={
                ...
                className={classNames("__wab_instance", sty.priceCard__duRE)}
              />
            </div>
          ) : null}
        </p.Stack>
